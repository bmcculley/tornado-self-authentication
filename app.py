...
class RegisterationHandler(BaseHandler):
    ...
    def post(self):
        ...
        getpassword = self.password_encypt(self.get_argument("password"))
...
class LoginHandler(BaseHandler):
    ...
    def post(self):
        ...
        hashedpassword = self.password_encypt(getpassword)

        user = self.db.get("SELECT * FROM users WHERE username = %s "
                           "OR email = %s",
...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        ...
        tornado.web.Application.__init__(self, [
            ...
            tornado.web.url(
                r'/register', RegisterationHandler, name="register"),
        ], **settings)
